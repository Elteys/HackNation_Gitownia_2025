					...
					<div className="bg-slate-50 rounded-xl p-6 mb-8 text-left space-y-4 border border-slate-200">
						<div className="flex items-center justify-between p-3 bg-white rounded-lg border border-slate-200">
							<div className="flex items-center gap-3">
								...
								<div>
									<p className="font-bold text-sm">Plik Metadanych (XML)</p>
									<p className="text-xs text-slate-500">
										Gateway dla automatów
									</p>
								</div>
							</div>
							<a
								href={publishResult.xml}
								target="_blank"
								rel="noreferrer"
		...
		<div className="max-w-2xl mx-auto px-4 py-8 animate-in zoom-in-95 duration-500">
			<div className="text-center mb-10">
				...
				<p className="text-slate-500 mt-2">
					Upewnij się, że wszystko się zgadza przed wystawieniem XML.
				</p>
			</div>
