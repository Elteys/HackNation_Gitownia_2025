...
import { Camera, FileText, Loader2, ArrowRight, ScanLine, QrCode } from 'lucide-react';
...
const Home = () => {
    ...
    const parseXML = (xmlString) => {
        try {
            ...
            if (xmlDoc.getElementsByTagName("parsererror").length > 0) throw new Error("Błąd parsowania XML");
            ...
            updateData({
                ...
                cechy: { kolor: getText('Kolor'), marka: getText('Marka'), stan: finalStan }
            });
            navigate('/formularz');
        } catch (e) {
            console.error(e);
    ...
    return (
        <div className="animate-in fade-in duration-700 max-w-6xl mx-auto px-4 py-6 md:py-12">
            ...
            {loading ? (
                <div role="status" aria-live="polite" className="flex flex-col items-center justify-center py-16 bg-white rounded-3xl shadow-sm border border-slate-200 mx-4">
                    <Loader2 className="w-12 h-12 text-blue-600 animate-spin mb-4" aria-hidden="true" />
                    <h2 className="text-lg font-semibold text-blue-900">Analiza obrazu...</h2>
                    <p className="text-sm text-slate-500 mt-1">Przetwarzam cechy i tłumaczę opisy</p>
                </div>
            ) : (
                <>
                    ...
                    <div className="space-y-4 md:space-y-0 md:grid md:grid-cols-2 md:gap-8 items-stretch">
                        ...
                        >
                            ...
                            <ArrowRight className="md:hidden text-slate-300 ml-2" size={24} />
                    ...
                    <div className="md:hidden mt-8">
                        ...
                        >
                            ...
                            <ScanLine className="text-slate-400 ml-2 animate-pulse" size={24} />
